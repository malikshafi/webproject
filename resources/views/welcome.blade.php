        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="{{asset('selling/images/model_1_bg.jpg') }}" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="{{asset('selling/images/model_2_bg.jpg') }}" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="{{asset('selling/images/model_3_bg.jpg') }}" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="{{asset('selling/images/model_4_bg.jpg') }}" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="{{asset('selling/images/model_5_bg.jpg') }}" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="product-item">
              <figure>
                <img src="{{asset('selling/images/product_1_bg.jpg') }}" alt="Image" class="img-fluid">
              </figure>
              <div class="px-4">
                <h3><a href="#">Wild West Hoodie</a></h3>
                <div class="mb-3">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person text-center">
              <img src="{{asset('selling/images/person_2.jpg') }}" alt="Image" class="img-fluid rounded w-75 mb-3">
              <h3>John Rooster</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person text-center">
              <img src="{{asset('selling/images/person_3.jpg') }}" alt="Image" class="img-fluid rounded w-75 mb-3">
              <h3>Tom Sharp</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person text-center">
              <img src="{{asset('selling/images/person_4.jpg') }}" alt="Image" class="img-fluid rounded w-75 mb-3">
      ...
      <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="{{asset('selling/images/person_3.jpg') }}" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
          ...
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="{{asset('selling/images/person_2.jpg') }}" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="{{asset('selling/images/person_4.jpg') }}" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
              <blockquote class="mb-3">
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
              </blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4 d-block align-items-center justify-content-center">
                <div><img src="{{asset('selling/images/person_1.jpg') }}" alt="Image" class="w-100 img-fluid mb-3"></div>
              </figure>
              <blockquote class="mb-3">
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
              </blockquote>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <a href="#"><img src="{{asset('selling/images/product_1_bg.jpg') }}" alt="Image" class="img-fluid mb-3"></a>
